...
export ZSH=/Users/harris/.oh-my-zsh
...
plugins=(git colored-man-pages colorize vagrant osx zsh-syntax-highlighting node nvm ssh-agent vim-interaction yarn mvn sudo dotenv thefuck nyan postgres fancy-ctrl-z)
